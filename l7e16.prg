/*16.Ler uma matriz A do tipo vetor com 5 elementos. Construir uma matriz B de mesmo tipo e dimensão, 
onde cada elemento da matriz B deverá ser o valor inverso (sinal trocado) do elemento
